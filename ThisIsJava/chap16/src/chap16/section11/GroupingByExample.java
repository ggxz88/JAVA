...
public class GroupingByExample {
	...
	public static void main(String[] args) {
		...
		List<Student> totalList = Arrays.asList(
			...
			new Student("김김김", 6, Student.Sex.MALE, Student.City.Pusan),
			new Student("이이이", 10, Student.Sex.MALE, Student.City.Pusan),
			new Student("박박박", 6, Student.Sex.MALE, Student.City.Seoul)
		);
